...
const BudgetCalculator: React.FC<BudgetCalculatorProps> = ({ isOpen, setIsOpen }) => {
  ...
  const calculateReachPerDay = (impressionsPerDay: number) => {
    return Math.round(impressionsPerDay / formData.hitsPerPersonPerDay);
  };
  ...
  useEffect(() => {
    ...
    const reach = calculateReach(impressions);
    const impressionsPerDay = calculateImpressionsPerDay(impressions);
    const reachPerDay = calculateReachPerDay(impressionsPerDay);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="max-w-3xl h-[80vh] overflow-hidden flex flex-col">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-center">Budget Calculator</DialogTitle>
              ...
              <TabsContent value="summary" className="space-y-6">
                <div className="space-y-6">
                  ...
                  <div className="bg-white dark:bg-gray-800 border rounded-lg p-4">
                    <h4 className="font-medium mb-4 text-center">Campaign Configuration</h4>
                  ...
                  <div className="bg-dopanet-50 dark:bg-dopanet-900/20 border border-dopanet-100 dark:border-dopanet-800/30 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm">
                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Estimated Reach</p>
                        <p className="text-2xl font-bold text-dopanet-600 dark:text-dopanet-400">
